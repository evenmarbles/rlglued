...
\begin{verbatim}
	examples/skeleton/SkeletonAgentpy
\end{verbatim}
...
The pertinent file is:
\begin{verbatim}
	examples/skeleton/SkeletonEnvironmentpy
\end{verbatim}
...
>$ PYTHONPATH=~/PythonCodec/src python SkeletonAgentpy &
RL-Glue Python Agent Codec Version: 2.0 (Build 250)
     Connecting to 127.0.0.1 on port 4096...
     Agent Codec Connected
     RL-Glue :: Agent connected.

>$ PYTHONPATH=~/PythonCodec/src python SkeletonEnvironmentpy &
RL-Glue Python Environment Codec Version: 2.0 (Build 250)
     Connecting to 127.0.0.1 on port 4096...
...
EXTRA SkeletonEnvironment(Python) by Brian Tanner.


----------Sending some sample messages----------
Agent responded to "what is your name?" 
with: my name is SkeletonAgent, Python edition!
...
with: my name is SkeletonEnvironment, Python edition!
...
\begin{verbatim}
> $ RLGLUE_PORT=1025 RLGLUE_HOST=yahoo.ca python skeletonagent.py\end{verbatim}
...
if __name__=="__main__":
     AgentLoader.loadAgent(SkeletonAgent())
\end{verbatim}
