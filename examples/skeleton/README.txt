...
$> python skeletonagent.py  #Alternatively, if you don't have the Python codec on your Python path
#$> PYTHONPATH=/path/to/python/codec/src python skeletonagent.py

$> python skeletonenvironment.py
$> python skeletonexperiment.py
